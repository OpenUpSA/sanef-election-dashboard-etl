...
Original file is located at
    https://colab.research.google.com/drive/1fg_VwkhtyMkdWuCID6TqnZtMCp1WcxCH
"""
...
df['Content'] = '-['+ df['financial_year'] + ': ' + df['document_type'] +'](' + df['original_url']  + ')'

#now group by  Geography
grouped_df = df.groupby("municipality")
...
grouped_lists.to_csv("reports_final.csv", index=None)